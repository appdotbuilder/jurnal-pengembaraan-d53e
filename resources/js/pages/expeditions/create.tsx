...
export default function CreateExpedition() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post(route('expeditions.store'), formData, {
    ...
    return (
        <AppShell>
            <Head title="Create Expedition - Jurnal Pengembaraan" />
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="mb-8">
                            ...
                            <p className="text-emerald-600 dark:text-emerald-300">
                                Document your mountain adventure and share it with the community
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            <div className="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-lg">
                                ...
                                <div className="mt-6">
                                    ...
                                    <textarea
                                        ...
                                        rows={4}
                                        className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-800 dark:text-gray-100"
                                        placeholder="Describe your expedition, what makes it special, and what others can expect to learn from it..."
                                    />
                                ...
                                <div className="mt-6">
                                    ...
                                    <textarea
                                        ...
                                        rows={3}
                                        className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-800 dark:text-gray-100"
                                        placeholder="What are the main goals and objectives of this expedition?"
                                    />
                                    {errors.main_objectives && <p className="mt-1 text-sm text-red-600">{errors.main_objectives}</p>}
                                </div>
                            </div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-800 dark:text-gray-100"
                                        />
                                        <p className="mt-1 text-sm text-gray-500">Upload a stunning photo that represents your expedition</p>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-800 dark:text-gray-100"
                                            placeholder="https://maps.google.com/... or other map service link"
                                        />
                                        <p className="mt-1 text-sm text-gray-500">Link to Google Maps, MyMaps, or other mapping service</p>
                                        {errors.map_embed_link && <p className="mt-1 text-sm text-red-600">{errors.map_embed_link}</p>}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex justify-end space-x-4">
                                ...
                                >
                                    {processing ? 'Creating...' : '🏔️ Create Expedition'}
                                </Button>
                            </div>
                        </form>
                    </div>
